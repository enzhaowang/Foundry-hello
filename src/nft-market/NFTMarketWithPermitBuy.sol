...
contract NFTMarket is ITokenReceiver, EIP712, Ownable{
    ...
    bytes32 private constant _BUY_NFT_TYPEHASH = keccak256("BuyNFT(address buyer,uint256 nonce,uint256 deadline)");
